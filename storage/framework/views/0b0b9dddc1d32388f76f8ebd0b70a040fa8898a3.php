...
<div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="./img/user.png" alt="Larastart Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                       <a class="nav-link" href="<?php echo e(route('logout')); ?>"
                                     ...
                                     <i class="nav-icon fas fa-power-off red"></i><p><?php echo e(__('Logout')); ?></p>
                                    </a>
...
<?php /**PATH C:\php7\xampp\htdocs\larastart\resources\views/layouts/master.blade.php ENDPATH**/ ?>